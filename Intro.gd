...
func _ready():
	...
	textbox.queue_content("I wish that I could help you more Matthiew, but this is a quest that only you can complete.\n\n\nWith that amulet you can use your own fears to fight against every enemy you could encounter.")
